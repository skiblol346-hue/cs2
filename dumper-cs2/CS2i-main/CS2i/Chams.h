...
public:
	const char* getName() const override { return "Chams"; }

	void update(bool menuOpen) override;
	Chams();

private:
	CS2::CStrongHandle<CS2::CMaterial2> CreateMaterial(const char* szMaterialName, const char szVmatBuffer[]);
	static bool OnDrawObject(void* pAnimatableSceneObjectDesc, void* pDx11, CS2::CMeshData* arrMeshDraw, int nDataCount, void* pSceneView, void* pSceneLayer, void* pUnk, void* pUnk2);
	bool OverrideMaterial(void* pAnimatableSceneObjectDesc, void* pDx11, CS2::CMeshData* arrMeshDraw, int nDataCount, void* pSceneView, void* pSceneLayer, void* pUnk, void* pUnk2);
		...
		R"(<!-- kv3 encoding:text:version{e21c7f3c-8a33-41c5-9977-a76d3a32aa0d} format:generic:version{7412167c-06e9-4698-aff2-e63eb59037e7} -->
{
	...
	static inline constexpr char szVMatBufferIlluminateInvisible[] =
		R"(<!-- kv3 encoding:text:version{e21c7f3c-8a33-41c5-9977-a76d3a32aa0d} format:generic:version{7412167c-06e9-4698-aff2-e63eb59037e7} -->
{
	shader = "csgo_complex.vfx"

...
// PS: We treat DBLCLK messages as regular mouse down messages, klngsley.dev so this code will work on windows classes that have the CS_DBLCLKS flag set. Our own example app code doesn't set this flag.

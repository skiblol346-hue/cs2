...
namespace
{
	...
	std::array<dx11::position, CIRCLE_POINT_COUNT * 8 + 8> circle_points;
...
void dx11::rectangle_filled_rounded(draw_buffer* buf,
	const position& top_left,
	const position& bot_right,
	const pos_type radius,
	const pack_color col_top_left,
...
void dx11::check_mark(draw_buffer* buf, position top_left, pos_type width, const pack_color col)
{

...
#include "..\cutlmemory\utlfixedmemory.h"
...
public:
	...
	void RemoveAll()
	{
		...
		{
			debug(iHead == InvalidIndex() && iTail == InvalidIndex() && iFirstFree == InvalidIndex() && nElementCount == 0);
			return;
		}

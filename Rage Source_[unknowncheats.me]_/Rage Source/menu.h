...
// ============================================
// ImGui Menu — Cs2 Rage Skin Changer
// ============================================
...
namespace Menu
{
    ...
    inline void LoadBackgroundImage(ID3D11Device* device)
    {
        ...
        unsigned char* data = stbi_load("c:\\Users\\MSZ\\source\\repos\\cs2\\Cs2 Rage\\bg.jpg", &w, &h, &channels, 4);
        if (!data) return;
...
namespace Hooks
{
    ...
    inline void RenderMenu()
    {
        ...
        ImGui::Begin("Cs2 Rage v1.4", &Hooks::showMenu, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse);
                    ...
                    if (ImGui::TreeNode("Custom Texture (Your Image on Weapon)"))
                    {
                        ...
                        else
                        {
                            ImGui::TextColored(ImVec4(1.0f, 1.0f, 0.3f, 1.0f), 
                                "BROWSE MODE — Look at your weapon!");
